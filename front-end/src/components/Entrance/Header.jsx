      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <a href="#demo" className="text-white hover:text-cyan-500 transition-colors duration-200">Try Demo</a>
            ...
            <a href="#features" className="text-white hover:text-cyan-500 transition-colors duration-200">AI Features</a>
          ...
          <div className="md:hidden flex items-center space-x-3">
            ...
            <Sheet open={isMenuOpen} onOpenChange={setIsMenuOpen}>
              ...
              <SheetContent 
                side="right" 
                className="w-[320px] sm:w-[400px] bg-white border-l border-cyan-500"
              >
                <SheetHeader className="pb-6 border-b border-white">
                  <SheetTitle className="flex items-center space-x-3 justify-start">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-cyan-500 font-semibold">Powered by AI</div>
                    </div>
                  </SheetTitle>
                </SheetHeader>
                <nav className="flex flex-col space-y-4 mt-8">
                  <a 
                    href="#demo" 
                    className="group flex items-center space-x-3 text-white hover:text-[#66B539] transition-all duration-300 text-lg font-medium py-3 px-4 rounded-lg hover:bg-cyan-50 hover:translate-x-1"
                    onClick={() => setIsMenuOpen(false)}
                  >
                    <Zap className="w-5 h-5 text-cyan-500 group-hover:text-[#66B539] transition-colors duration-300" />
                    <span>Try Demo</span>
                  </a>
                  <a 
                    href="#reviews" 
                    className="group flex items-center space-x-3 text-white hover:text-cyan-500 transition-all duration-300 text-lg font-medium py-3 px-4 rounded-lg hover:bg-cyan-50 hover:translate-x-1"
                    onClick={() => setIsMenuOpen(false)}
                  >
                    <Star className="w-5 h-5 text-cyan-500 group-hover:text-[#66B539] transition-colors duration-300" />
                    <span>Reviews</span>
                  </a>
                  <a 
                    href="#stats" 
                    ...
                    onClick={() => setIsMenuOpen(false)}
                  >
                    <ChartNoAxesCombined className="w-5 h-5 text-cyan-500 group-hover:text-[#66B539] transition-colors duration-300" />
                    <span>Stats</span>
                  </a>
                  <a 
                    href="#features" 
                    ...
                    onClick={() => setIsMenuOpen(false)}
                  >
                    <BrainCircuit className="w-5 h-5 text-cyan-500 group-hover:text-[#66B539] transition-colors duration-300" />
                  ...
                  <a 
                    ...
                    onClick={() => setIsMenuOpen(false)}
                  >
                    <Contact className="w-5 h-5 text-cyan-500 group-hover:text-[#66B539] transition-colors duration-300" />
