          ...
          <div className="md:hidden flex items-center">
            <Sheet open={isMenuOpen} onOpenChange={setIsMenuOpen}>
              <SheetTrigger asChild>
                <button className="bg-gradient-to-br from-cyan-500 to-cyan-600 hover:from-[#8FE877] hover:to-cyan-500 text-white font-bold w-10 h-10 rounded-full transition-all duration-200 text-sm flex items-center justify-center shadow-lg hover:shadow-xl transform hover:scale-105 ring-2 ring-white/20">
                  {user && user.userName?.[0]?.toUpperCase()}
                </button>
              </SheetTrigger>
              ...
              <SheetContent
                side="right"
                className="w-[320px] sm:w-[400px] bg-white border-l border-cyan-100 z-[70] flex flex-col data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-right-full data-[state=open]:duration-300 data-[state=closed]:duration-300"
              >
                <SheetHeader className="pb-6 border-b border-cyan-100 flex-shrink-0">
                  <SheetTitle className="flex items-center space-x-3">
                    ...
                    <span className="text-xl font-bold text-white">{user && user.userName}</span>
                  </SheetTitle>
                </SheetHeader>
                        ...
                        <button
                          ...
                          className={`group flex items-center space-x-3 px-4 py-3 rounded-lg text-left transition-all duration-300 ${
                            isActive
                              ...
                              : 'text-white hover:text-cyan-500 hover:bg-cyan-500/5'
                          }`}
                        >
                          <div className="p-2 bg-cyan-500/10 rounded-md">
                            <Icon className={`w-5 h-5 ${isActive ? 'text-cyan-600' : 'text-cyan-500'}`} />
                          </div>
                ...
                <div className="flex-shrink-0 border-t border-cyan-100 pt-4">
                  <button
                    className="w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-300 text-white hover:text-red-500 hover:bg-red-50 group"
                  ...
                  >
                    ...
                    <div className="flex-1 text-left">
                      ...
                      <div className="text-xs text-white">Sign out of your account</div>
                    </div>
                  </button>
                </div>
              </SheetContent>
